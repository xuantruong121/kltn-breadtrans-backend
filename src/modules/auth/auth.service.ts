...
export class AuthService {
  ...
  async refreshTokens(userId: number, deviceId: string, providedRefreshToken: string) {
    ...
    if (storedToken !== providedRefreshToken) {
      ...
      throw new UnauthorizedException('Replay attack detected or token expired. Session revoked.');
    }
