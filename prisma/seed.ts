...
async function main() {
  ...
  // ==========================================
  // 1. USERS & PROFILES & STATS & BILLING & PETS
  // ==========================================
  ...
  // 12 Students with realistic avatars and stats
  ...
  // ==========================================
  // 3. COURSES, CLASSES, LESSONS, SESSIONS, ATTENDANCE, MATERIALS
  // ==========================================
  ...
  for (let cIdx = 0; cIdx < classes.length; cIdx++) {
    ...
    // Seed Materials attached to Lesson
    if (lesson) {
  ...
  for (let cIdx = 0; cIdx < 4; cIdx++) {
    ...
    // Seed 2 Submissions with grades and teacher feedbacks
  ...
  // ==========================================
  // 5. VOCABULARY TOPICS & FLASHCARD WORDS
  // ==========================================
  ...
  // ==========================================
  // 6. PRACTICE TOPICS & GRAMMAR QUIZZES
  // ==========================================
  ...
  // ==========================================
  // 7. GRAMMAR TOPICS (Video & Quiz Module)
  // ==========================================
  ...
  // ==========================================
  // 9. SPEAKING EXERCISES (Phát âm & Giao tiếp)
  // ==========================================
  ...
  // ==========================================
  // 10. CONTENT TOPICS (Phim & Nhạc Học Tiếng Anh)
  // ==========================================
